...
class RelatoriosRepository:
    def __init__(
        self,
        caminho_arquivo: str = "database/relatorios_execucao.json"
    ) -> None:
    ...
    def salvar(
        ...
        logger.info(
            "Relatório da execução salvo em: %s",
    ...
    def _carregar_relatorios(
        ...
        try:
            ...
            logger.exception(
                "Não foi possível ler o histórico de relatórios."
            )
    ...
    def _salvar_relatorios(
        ...
        try:
            ...
            logger.exception(
                "Não foi possível salvar o histórico de relatórios."
            )