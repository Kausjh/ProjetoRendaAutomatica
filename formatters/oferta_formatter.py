...
class OfertaFormatter:
    ...
    @staticmethod
    def formatar(oferta: Oferta, resultado_historico: ResultadoHistoricoPreco | None = None) -> str:
        informacao_preco = OfertaFormatter._formatar_preco(oferta)
...
"""
    ...
    @staticmethod
    def _formatar_preco(oferta: Oferta) -> str:
        if oferta.preco_antigo is not None and oferta.desconto_percentual > 0:
            return f"""
...
"""
    ...
    def _formatar_historico(
        oferta: Oferta, resultado_historico: ResultadoHistoricoPreco | None
    ) -> str:
        ...
        if not (resultado_historico.preco_caiu or resultado_historico.preco_subiu):
            return ""
        ...
        variacao_absoluta = abs(resultado_historico.variacao_percentual)
