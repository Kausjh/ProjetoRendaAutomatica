...
def executar_teste() -> None:
    ...
    casos = [
        ...
        (
            "Fonte ATX 750W 80 Plus Bronze",
            True,
            "Fonte"
        ),
        (
            "Monitor Gamer IPS 180Hz 24 polegadas",
            True,
            "Monitor"
        ),
        (
        ...
        (
            "Livro sobre montagem de computadores",
            False,
            None
        ),
        (
    ...
    for indice, caso in enumerate(
        ...
        resultado = classificador.aplicar_classificacao(
            oferta
        )
        ...
        print(
            "Termos encontrados: "
            f"{resultado.termos_encontrados}"
        )
