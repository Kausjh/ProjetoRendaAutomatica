        ...
        class Handler(BaseHTTPRequestHandler):
            def do_GET(self) -> None:
                ...
                try:
                    ...
                    if rota == "/monetizacao/operacional":
                        dados = controlador.obter_snapshot_monetizacao()
                        self._responder_json(200, dados)
                        return
                    ...
                    if rota == "/monetizacao/alertas":
                        dados = controlador.obter_alertas_monetizacao()
                        self._responder_json(200, dados)
                        return

                    if rota == "/monetizacao/shadow":
                        dados = controlador.obter_recomendacao_shadow_monetizacao()
                        self._responder_json(200, dados)
                        return
