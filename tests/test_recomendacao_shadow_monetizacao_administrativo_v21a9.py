...
def test_v21a9_rota_shadow_permanece_read_only():
    fonte = Path("services/controle/servidor_status.py").read_text(encoding="utf-8-sig")
    ...
    assert 'if rota == "/monetizacao/shadow":' in trecho_get
    assert "controlador." "obter_recomendacao_shadow_monetizacao()" in trecho_get
